...
This project creates a Fedora toolbox with VSCodium - the open-source version of Visual Studio Code - pre-installed. As such, it provides a script to get you up and running with a bare bones development environment. 
